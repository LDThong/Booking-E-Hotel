  ...
  return (
    <div className='lg:flex lg:h-screen lg:p-[20px]
        ...
        <div className='lg:w-[65%] lg:h-full lg:bg-[#fff] lg:rounded-tr-[15px] lg:rounded-br-[15px]
            ...
            <Link to={'/'} className='lg:hidden max-sm:block sm:max-lg:hidden'>
                <div className='text-[#A3258E] flex items-center gap-[5px] mt-[10px] max-sm:bg-[#fff] w-fit max-sm:p-[3px_10px_3px_10px] rounded-[15px]
                    sm:max-lg:p-[5px_0_0_25px]'>
                    <FaHotel className='text-[20px]' />
                    <p className='max-sm:font-semibold sm:max-lg:font-bold'>Home Page</p>
                </div>
            </Link>
